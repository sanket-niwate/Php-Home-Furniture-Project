...
<body>
                    ...
                    <ul class="navbar-nav mt-2 mt-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="dropdownId" data-bs-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false" style="color: rgb(255, 123, 0)">Products</a>
                            <div class="dropdown-menu px-2" aria-labelledby="dropdownId">
                                ...
                                <a class="nav-link pt-0 active" href="pview.php">Chair</a> <a class="nav-link pb-1"
                                    href="pviewsofa.php" style="color: rgb(255, 123, 0)">Sofas</a> <a
                                    class="nav-link pb-1" href="pviewtable.php">Tables</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="dropdownId" data-bs-toggle="dropdown"
    ...
    <main>
        <div class="position-fixed bottom-0 end-0 mb-3 me-3 bd-mode-toggle">
            <a class="text-white nav-link" href="eqorder.html">
                <button class="btn btn-bd-primary py-2 d-flex align-items-center">
                    <span class="" id="bd-theme-text">Order For Bulk </span>
                </button></a>
        </div>
        <?php 
            include('config.php');

            $sql = "SELECT * FROM `productssofa`";
            $result = mysqli_query($conn, $sql);

            if (mysqli_num_rows($result) > 0) {
                echo "<div class='container'>
                <h2 class='text-center mb-4'>Sofas</h2>
                        <div class='row g-2'>";

                while ($row = mysqli_fetch_assoc($result)) {
                    echo "<div class='col-sm-12 col-md-6 col-lg-4 col-xl-3'>
                            <div class='card'>
                                <img class='card-img-top' src='products/{$row['image']}' alt='Title' />
                                <div class='card-body'>
                                    ...
                                    font-family: Arial, sans-serif;
                                  '>{$row['name']}</h4>
                                    <p class='card-text text-center'  style='background-color: #ffd166'>{$row['description']}</p>
                                    <p><b>MRP:  <s>₹ {$row['mrp']}</s></b></p>
                                    <p><b>Offer Price: ₹ {$row['sp']}</b></p>
                                    <a class='btn btn-primary' href='add_to_cart.php?id={$row['id']}' role='button'    style='background-color:  rgb(255, 123, 0); border-color:rgb(255, 123, 0) ;'>Add To Cart</a>

                                 
                                    <a name='' id='' class='btn btn-success' href='order.html?id={$row['id']}' role='button'>Bulk Order</a>
                                </div>
                            </div>
                        </div>";
                }
            ...
            ">
                <div class="col-6">
                    ...
                    <img class="p-1 img-fluid" width="40" height="40" src="Images/call-receive-svgrepo-com.png"
                        alt="" />&nbsp;
                    <img class="p-1 img-fluid" width="40" height="40" src="Images/email-1573-svgrepo-com.png" alt="" />
                    ...
                    <img class="p-1 img-fluid" width="40" height="40" src="Images/youtube-168-svgrepo-com.png"
                        alt="" />&nbsp;
                    <img class="p-1 img-fluid" width="45" height="45" src="Images/telegram-svgrepo-com.png" alt="" />
                </div>
                <div class="col-6">
                    <p>Download App:</p>
                    <img class="img-fluid py-1" width="150" height="150" src="Images/google-play-badge.jpg" alt="" />
                    <img class="img-fluid py-1" width="150" height="150" src="Images/google-play-badge.jpg" alt="" />
                </div>
            </div>
        </div>
