                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu px-2" aria-labelledby="dropdownId">
                                ...
                                <a class="nav-link pt-0 active" href="pview.php">Chair</a> <a class="nav-link pb-1"
                                    href="pviewsofa.php">Sofas</a> <a class="nav-link pb-1" href="pviewtable.php"
                                    style="color: rgb(255, 123, 0)">Tables</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="dropdownId" data-bs-toggle="dropdown"
    ...
    <main>
        ...
        <?php 
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                <h2 class='text-center mb-4'>Tables</h2>
                        <div class='row g-2'>";
                            ...
                            <div class='card'>
                                ...
                                <div class='card-body'>
                                  ...
                                  '>{$row['name']}</h4>
                                    ...
                                    <a name='' id='' class='btn btn-success' href='order.html?id={$row['id']}' role='button'>Bulk Order</a> </div>
                            </div>
                        </div>";
                }
